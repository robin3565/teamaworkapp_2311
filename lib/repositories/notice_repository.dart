...
class NoticeRepository {
  static const targetUrl =
      'http://server.teama.company/board/erp_get_board_list';
  static final dio = Dio();

  static Future<NoticeModel> getNoticeInfo(
      memUid, bdType, pageSize, page) async {
    final formData = {
      // 'os_type': osType,
      // 'device_id': deviceId,
    ...
    if (response.statusCode == 200) {
      ...
      if (json_ != null && json_['result'] == 'OK') {
        ...
        final notice = NoticeModel.fromJson(data_);
        return notice;
      }
    }

    throw Exception('Failed to fetch notice information');
  }
}
